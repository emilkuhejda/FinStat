...
namespace FinStat.Domain.Interfaces.Services
{
    public interface IWebService
    {
        ...
        Task<HttpRequestResult<IncomeStatement[]>> GetIncomeStatementsAsync(string ticker, bool isQuarterPeriod, int limit = 20, CancellationToken cancellationToken = default);
    }
}
